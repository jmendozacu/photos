...
//    $('onepagecheckout_loginbox').show();
    if ($('.opc-customer-container').css('display') == 'none') {
        $('#onepagecheckout_forgotbox').hide();
        $('#onepagecheckout_loginbox').show();
    }
    $('.opc-customer-container').slideToggle();
}function open_forgot() {
    var $ = jQuery;
    //$('onepagecheckout_loginbox').hide();
//    $('onepagecheckout_forgotbox').show()    
    $('#onepagecheckout_loginbox').hide();
    $('#onepagecheckout_forgotbox').fadeIn(200);
}
function return_login() {
    var $ = jQuery;    
    $('#onepagecheckout_forgotbox').hide();
    $('#onepagecheckout_loginbox').fadeIn(200);
}
function open_coupon() {
    var $ = jQuery;
    $('#checkout-coupon-discount-load').slideToggle();
}
